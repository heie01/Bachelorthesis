...
def main(heels_desity, fronts_desity,heel_pos_x, heel_pos_y, rows, cols, POS, starting_pos_x,starting_pos_y, radius_fronts_avg, keep_fil_num):
        ...
        for R in np.arange(42*6):
            ...
            if making_movie:
                if R == 80:
                    ...
                    #plt.scatter(xfil,yfil,color =["b","b","b","b","b","g","g","g","g","g"], s = 1)
